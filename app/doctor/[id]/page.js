...
export default function DoctorPrescriptionPage() {
  ...
  const filteredPicker = useMemo(() => {
    let list =
      selectedCondition === "All"
        ? allMedicines
        : (MEDICINES_BY_CONDITION[selectedCondition] || []).map((m) => ({
            ...m,
  ...
  return (
    <>
      ...
      <main
        className="min-h-screen bg-emerald-50 p-4 pb-24 no-print"
        ref={printRef}
      >
                            ...
                            <tbody>
                              {pastMeds.map((m, i) => (
                                ...
                                >
                                  ...
                                  <td className="py-1 pr-2 text-indigo-700">
                                    {m.dose}
                                  </td>
            ...
            {showPicker && (
              <>
                ...
                <p className="text-[11px] text-gray-500 mb-2">
                  Tap medicine → choose dose
                </p>

                {(() => {
                  // Class के हिसाब से group करो
                  const grouped = {};
                        ...
                        <div key={cls}>
                          ...
                          <div className="flex flex-col gap-2">
                            {grouped[cls].map((med, idx) => {
                              ...
                              const saltAdded = addedNames.has(
                                med.name.toLowerCase().split(" ")[0],
                              );
