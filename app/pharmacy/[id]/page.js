...
export default function PharmacyPrescriptionPage() {
  ...
  useEffect(() => {
    async function load() {
      ...
      const brandsMap = brandsData.brands || {};
      ...
      <main className="min-h-screen bg-orange-50 p-4 pb-24 no-print">
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow p-4 mb-4">
            ...
            <p className="text-xs text-gray-400 mt-1">Token #{prescription.id} · {prescription.visit_date?.slice(0, 16)}</p>
        ...
        <table className="w-full text-sm border-collapse mb-4">
          ...
          <tfoot>
            <tr className="bg-gray-50">
              <td colSpan={6} className="border border-gray-300 px-2 py-2 text-right font-bold">
                Total
              </td>
