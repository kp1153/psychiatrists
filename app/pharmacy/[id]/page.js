        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow p-4 mb-4">
            ...
            <div className="flex flex-col gap-3">
              {medicines.map((m, i) => (
                <div key={i} onClick={() => !done && toggleDispensed(i)} className={`flex items-start gap-3 p-3 rounded-xl border transition cursor-pointer ${dispensed[i] ? "bg-green-50 border-green-300" : "bg-gray-50 border-gray-200"}`}>
                  <div className={`w-5 h-5 rounded-full border-2 mt-0.5 flex-shrink-0 transition ${dispensed[i] ? "bg-green-500 border-green-500" : "border-gray-300"}`} />
                  <div>
          ...
          {done ? (
            ...
            <button onClick={markDone} disabled={saving} className="w-full bg-orange-500 text-white py-3 rounded-xl font-semibold text-base hover:bg-orange-600 disabled:opacity-60 transition">
